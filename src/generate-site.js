...
function generateHTML(fullTeam) {
  ...
  const ManagerSumm = (name, email, IDname, officeNumber) => {
  ...
  const EngineerSumm = (name, email, IDname, Github) => {
    return `<div class="card" style="width: 18rem;">
      <div class="card-header p-4">
        <h2>${name}</h2>
  ...
  const InternSumm = (name, email, IDname, school) => {
    return `<div class="card" style="width: 18rem;">
      <div class="card-header p-4">
        <h2>${name}</h2>
...
module.exports = {
  EngineerSumm: EngineerSumm,
  ManagerSumm: ManagerSumm,
  InternSumm: InternSumm
}